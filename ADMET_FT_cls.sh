...
run_command() {
    ...
    fairseq-train --user-dir ./graphormer \
        ...
        --best-checkpoint-metric roc_auc --maximize-best-checkpoint-metric --num-workers 0 --task dft_md_combine --criterion mae_dft_md --arch IEFormer_ep_pp_dft_md \
